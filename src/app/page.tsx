            ...
            <div className="text-center">
              ...
              <div className="mt-12 flex justify-center">
                <button
                  ...
                  className="group inline-flex items-center justify-center px-12 py-4 border border-transparent text-lg font-semibold rounded-xl text-blue-700 bg-white hover:bg-blue-50 shadow-2xl hover:shadow-blue-500/25 transform hover:-translate-y-1 transition-all duration-300"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="pt-8">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Connect Wallet & Sign In</h3>
                  <p className="text-gray-600 mb-4">Sign in with your university email (.edu) and connect your MetaMask wallet for secure, blockchain-powered property browsing.</p>
